    ...
    <div className="mb-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7A9E7E]"
          required
        />
      </div>
      ...
      <div className="mt-4 grid grid-cols-3 sm:grid-cols-3 gap-2">
        <div className="col-span-1">
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full px-2 sm:px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7A9E7E] text-sm sm:text-base"
            required
          >
