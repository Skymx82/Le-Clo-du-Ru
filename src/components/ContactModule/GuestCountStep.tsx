  ...
  return (
    <div className="mb-8">
        ...
        <div className="flex items-center justify-between py-4 border-b border-gray-100">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              disabled={adults <= 1}
              className={`w-8 h-8 rounded-full flex items-center justify-center ${adults <= 1 ? 'bg-gray-100 text-gray-400' : 'bg-[#E8F1E4] text-[#5B7B5E] hover:bg-[#D8E8D5]'}`}
            ...
            <button
              ...
              disabled={adults >= 6}
              className={`w-8 h-8 rounded-full flex items-center justify-center ${adults >= 6 ? 'bg-gray-100 text-gray-400' : 'bg-[#E8F1E4] text-[#5B7B5E] hover:bg-[#D8E8D5]'}`}
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              disabled={children <= 0}
              className={`w-8 h-8 rounded-full flex items-center justify-center ${children <= 0 ? 'bg-gray-100 text-gray-400' : 'bg-[#E8F1E4] text-[#5B7B5E] hover:bg-[#D8E8D5]'}`}
            ...
            <button
              ...
              disabled={children >= 4}
              className={`w-8 h-8 rounded-full flex items-center justify-center ${children >= 4 ? 'bg-gray-100 text-gray-400' : 'bg-[#E8F1E4] text-[#5B7B5E] hover:bg-[#D8E8D5]'}`}
      ...
      <div className="mt-6 text-center">
        <div className="inline-flex items-center px-4 py-2 bg-[#E8F1E4] rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#5B7B5E] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
